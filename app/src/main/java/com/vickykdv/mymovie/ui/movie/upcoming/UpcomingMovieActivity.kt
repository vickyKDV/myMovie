...
import com.vickykdv.mymovie.databinding.ActivityUpcomingMovieBinding
...
class UpcomingMovieActivity : AppCompatActivity() {
    ...
    private fun setupStatusBar() {
        with(window){
            ...
            navigationBarColor = ContextCompat.getColor(this@UpcomingMovieActivity, android.R.color.white)
            statusBarColor = ContextCompat.getColor(this@UpcomingMovieActivity, android.R.color.white)
        }
    }
}