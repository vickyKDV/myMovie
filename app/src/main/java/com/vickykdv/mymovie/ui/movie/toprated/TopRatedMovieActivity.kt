...
import com.vickykdv.mymovie.databinding.ActivityMovieTopRatedBinding
...
class TopRatedMovieActivity : AppCompatActivity() {
    ...
    private fun setupStatusBar() {
        with(window){
            ...
            navigationBarColor = ContextCompat.getColor(this@TopRatedMovieActivity, android.R.color.white)
            statusBarColor = ContextCompat.getColor(this@TopRatedMovieActivity, android.R.color.white)
        }
    }
}